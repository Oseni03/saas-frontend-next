    ...
    >
      ...
      <div className="text-center space-y-4 max-w-2xl mx-auto relative z-10">
        ...
        <p className="text-sm md:text-base text-foreground/60 leading-relaxed">
          Founded in 2024, Index started with a simple belief: publishing
          beautiful pages should be effortless, secure by default, and
          cost-efficient.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        <div className="space-y-6">
          ...
          <p className="text-xs md:text-sm text-foreground/60 leading-relaxed">
            Traditional publishing platforms force creators to split their focus
            across countless formatting options, SEO configurations, and complex
            site builders.
          </p>
          <p className="text-xs md:text-sm text-foreground/60 leading-relaxed">
            Index removes this friction. By providing a minimal,
            distraction-free writing environment with one-click publishing, we
            let you concentrate fully on creating great content.
          </p>
        </div>
      ...
      <div className="border border-border bg-foreground/[0.02] p-8 text-center space-y-6 md:p-12 relative z-10">
        ...
        <p className="text-xs md:text-sm text-foreground/60 max-w-md mx-auto">
          Convert your plain text into professional, lightning-fast public pages
          in seconds.
        </p>
        <div className="pt-2">
          <Button
