    ...
    >
      <div className="text-center space-y-4 max-w-2xl mx-auto">
        ...
        <p className="text-xs md:text-sm text-foreground/60">
          Last revised: June 10, 2026. Explore our transparent policies on data
      ...
      <div className="flex flex-wrap items-center justify-center gap-6 pt-8 border-t border-border text-[10px] font-mono text-foreground/50">
        <span className="flex items-center gap-1">
          <CheckCircle className="h-3.5 w-3.5 text-primary" /> CCPA Compliant
        </span>
        <span className="flex items-center gap-1">
          <CheckCircle className="h-3.5 w-3.5 text-primary" /> ISO/IEC 27001
          Shielded
        </span>
        <span className="flex items-center gap-1">
          <CheckCircle className="h-3.5 w-3.5 text-primary" /> HIPAA Security
          Safe
        </span>
      </div>
    </div>
