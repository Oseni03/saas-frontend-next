  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col items-center">
        ...
        >
          Index turns your plain-text notes, guides, and newsletters into
          beautiful, professional, and lightning-fast public pages. No technical
          setups, no custom coding, and no complex site-building. Just pure,
          beautiful writing.
        </p>
          ...
          <div className="flex flex-col lg:flex-row min-h-[400px]">
              ...
              <div className="flex flex-col">
                ...
                <div className="flex flex-col py-1.5">
                  <div className="px-3 py-1.5 flex items-center gap-2 text-foreground font-semibold bg-foreground/[0.03]">
                    ...
                    <span className="truncate">welcome-guide.md</span>
                  </div>
                  <div className="px-3 py-1.5 flex items-center gap-2 hover:bg-foreground/[0.02] cursor-pointer">
                    ...
                    <span className="truncate">recipe-ideas.md</span>
                  </div>
                  <div className="px-3 py-1.5 flex items-center gap-2 hover:bg-foreground/[0.02] cursor-pointer">
                    <FileText className="w-3 h-3 text-foreground/40" />
                    <span className="truncate">summer-photos.md</span>
                  </div>
                  <div className="px-3 py-1.5 flex items-center gap-2 hover:bg-foreground/[0.02] cursor-pointer">
                    <FileText className="w-3 h-3 text-foreground/40" />
                    <span className="truncate">quick-thoughts.txt</span>
                  </div>
                </div>
              </div>
            ...
            <div className="flex-1 flex flex-col min-w-0">
              ...
              <div className="p-4 md:p-6 flex-1 flex flex-col gap-3 font-mono text-[11px] leading-relaxed text-foreground select-text selection:bg-foreground selection:text-background">
                ...
                <div>
                  <span className="text-foreground/40">title:</span> "Welcome to
                  My Cozy Travel Journal"
                </div>
                <div>
                  <span className="text-foreground/40">author:</span> "Ayomide
                  Oseni"
                </div>
                <div>
                  <span className="text-foreground/40">category:</span> "My
                  Adventures"
                </div>
                <div className="text-foreground/45">---</div>
                <br />
                ...
                <div>
                  Last week, we hiked along the volcanic paths of Santorini. The
                  Aegean Sea stretched out forever in an intense, glittering
                  cobalt blue.
                </div>
                <br />
                <div className="font-bold">## Three Things to Remember:</div>
            ...
            <div className="w-full lg:w-72 border-t lg:border-t-0 lg:border-l border-border p-4 flex flex-col gap-4 bg-foreground/[0.01]">
              ...
              <div className="flex-1 flex flex-col bg-muted p-2 font-mono text-[9px] text-foreground/60 leading-normal overflow-hidden select-none">
                ...
                <div>15:00:53 [SAVE] Synced with cloud folder...</div>
                <div>15:00:53 [FORMAT] Built beautiful typography.</div>
                <div>15:00:54 [PUBLISH] HTML page generated.</div>
