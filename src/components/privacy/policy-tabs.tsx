...
const clauses = [
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          When utilizing the Index platform, we gather specific details
        ...
        <ul className="list-disc pl-5 space-y-2 text-xs md:text-sm">
          <li>
            ...
            collect your name, email address, and encrypted authentication
            credentials.
          </li>
          <li>
            <strong>Content Data:</strong> We store the content you create and
            publish through our platform. This data is encrypted at rest and
            only accessible to you and those you explicitly share it with.
          </li>
          <li>
            <strong>Usage Analytics:</strong> We collect anonymous usage
            statistics to improve our service. We do NOT analyze the content of
            your writing.
          </li>
        </ul>
      </div>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          The protection of your data is our highest priority. We operate under
          strict security protocols:
        </p>
        <ul className="list-disc pl-5 space-y-2 text-xs md:text-sm">
          <li>
            <strong>Encryption in Transit:</strong> All data transferred between
            your browser and our servers is encrypted using TLS 1.3.
          </li>
          <li>
            <strong>Encryption at Rest:</strong> Your content and personal
            information are encrypted at rest using industry-standard AES-256
            encryption.
          </li>
          <li>
            <strong>Access Control:</strong> We follow the principle of least
            privilege. Only essential personnel have access to production
            systems, and all access is logged and audited.
          </li>
        </ul>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          Index aligns with international guidelines protecting user data and
          privacy:
        </p>
        <ul className="list-disc pl-5 space-y-2 text-xs md:text-sm">
          <li>
            <strong>GDPR & CCPA Compliance:</strong> Users from the European
            Union and California retain full control over their data. You can
            request export or deletion of your data at any time.
          </li>
          <li>
            <strong>No Data Sales:</strong> Index has never sold, traded, or
            shared personal data with third-party marketing services.
          </li>
          <li>
            <strong>Transparent Operations:</strong> We are committed to
            transparency about how your data is collected, stored, and used.
          </li>
        </ul>
      </div>
    ),
      ...
      <div className="flex lg:flex-col gap-2 overflow-x-auto lg:overflow-visible pb-2 lg:pb-0 lg:border-r border-border lg:pr-4">
        {clauses.map((clause) => {
          ...
          return (
            <Button
              key={clause.id}
              variant={activeSection === clause.id ? "default" : "outline"}
              size="sm"
